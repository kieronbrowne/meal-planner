define(
	...
	var view = Backbone.View.extend({
		...
		if (typeof mealModel == 'undefined') {
		    // try a recipe then
		    recipeModel = window.calApp.collections.recipes.get(meal.id);
		    mealModel = new MealModel({name: recipeModel.attributes.name, recipe: recipeModel});
